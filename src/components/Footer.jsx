      ...
      >
        ...
        <div className="flex flex-col justify-center items-start gap-5 ">
          ...
          <p className="text-slate-200 text-justify ">
            ...
            veritatis debitis fugiat veniam cum voluptas corrupti culpa quam
            ipsa molestias.
          </p>
          {/* social icons */}
          <div
        ...
        <div className="flex flex-col justify-center items-start gap-5 ">
          ...
          <div className="flex justify-center items-center gap-3 ">
            ...
            <p className="text-slate-200 ">
              Lorem ipsum dolor sit, Voluptas, accusantium.
            </p>
          </div>
          {/* sec */}
          <div className="flex justify-center items-center gap-3 ">
          ...
          <div className="flex justify-center items-center gap-3 ">
            ...
            <p className="text-slate-200 ">practice@mail.com</p>
          </div>
        </div>
        {/* third row */}
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 ">$ 93.44</p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 ">$ 73.34</p>
            </div>
          </div>
        </div>
      </footer>
