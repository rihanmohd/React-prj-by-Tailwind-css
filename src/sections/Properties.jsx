  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      ...
      >
        ...
        <div
          id="grid-box"
          className="w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center
         gap-8 "
        >
            ...
            >
              ...
              <div className="px-6  py-3 flex flex-col justify-center items-start gap-2 w-full ">
                ...
                >
                  ...
                  <div className="flex justify-center items-center gap-4 ">
                    {/* first i*/}
                    <div className="p-2 border-2 border-gray-400 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300">
