...
import "aos/dist/aos.css";
 ...
 const About = () => {
  ...
  return (
    ...
    <div className=''>
    <img data-aos="zoom-in" src={aboutimg} alt="abot image" className='rounded-2xl  lg:w-[500px]  lg:h-[600px] ' />
    </div>
    ...
    <div className='flex flex-col justify-center items-start gap-8 '>
       ...
       <p  data-aos="zoom-in" data-aos-delay="400"  className='text-xl text-gray-600 dark:text-white text-justify '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel vitae eius architecto repellendus eos quas eaque voluptates doloribus incidunt tenetur, eligendi non voluptas, cum reprehenderit.</p>
       {/* button */}
